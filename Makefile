...
SRCS := \
    ...
    noisereduction/BufferedInputTrack.cpp \
    noisereduction/BufferedOutputTrack.cpp \
    noisereduction/BufferedNoiseReduction.cpp \
    noisereduction/BufferedTrackUtils.cpp
